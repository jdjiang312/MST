...
class SemSegEvaluator(HookBase):
    ...
    def eval(self):
        ...
        for i, input_dict in enumerate(self.trainer.val_loader):
            ...
            # Updated to receive TP, FP, FN, and TN
            intersection, union, target, fp, fn, tn = intersection_and_union_gpu(
                pred,
                segment,
            ...
            self.trainer.logger.info(
                f"Class-wise metrics: TP={intersection.tolist()}, FP={fp.tolist()}, "
                f"FN={fn.tolist()}, TN={tn.tolist()}"
            )
