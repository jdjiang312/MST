...
from pointcept.utils.condition import canonicalize_condition, infer_condition
...
class S3DISDataset(Dataset):
    def __init__(
        ...
        self.condition = canonicalize_condition(condition)
    ...
    def get_data(self, idx):
        ...
        if condition is None:
            condition = canonicalize_condition(data.get("condition", None))
        if condition is None:
            condition = infer_condition(scene_id, self.data_root, name)
