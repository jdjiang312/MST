...
# model settings
platform_conditions = ('ALS', 'ULS', 'MLS')
platform_condition = 'ULS'  # set this to the real platform of the dataset; for TLS transfer use 'MLS'
model = dict(
    type='PG-v1m1',
    backbone=dict(
        type='MST-v1m1',
        backbone=dict(
            ...
            CIM_adaptive=False,
            CIM_affine=True,
            CIM_conditions=platform_conditions),
        criteria=[
            dict(type='CrossEntropyLoss', loss_weight=1.0, ignore_index=-1)
        ],
        backbone_out_channels=64,
        context_channels=256,
        conditions=platform_conditions,
        template='[x]',
        clip_model='ViT-B/16',
        class_name=('tree', ),
        valid_index=((0, ), (0, ), (0, )),
